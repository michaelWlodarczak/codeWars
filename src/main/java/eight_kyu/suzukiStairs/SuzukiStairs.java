package eight_kyu.suzukiStairs;
...
he must train in the morning. He is curious how many stairs might be climbed over the next 20 years
...
7148, 6152, 5940, 8040, 9174, 7555, 7682, 5252, 8793, 8837, 7320, 8478, 6063, 5751,
9716, 5085, 7315, 7859, 6628, 5425, 6331, 7097, 6249, 8381, 5936, 8496, 6934, 8347,
...
//    return 20 * Arrays.stream(stairs).flatMapToInt(arr -> Arrays.stream(arr)).sum();
    ...
    public static void main(String[] args) {
        ...
        int[] sunday = {1,2,3,4};
        int[] monday = {5,6,7,8};
        int[] tuesday = {9,10,11,12};
        int[] wednesday = {13,14,15,16};
        int[] thursday = {17,18,19,20};
        int[] friday = {21,22,23,24};
        int[] saturday = {25,26,27,28};

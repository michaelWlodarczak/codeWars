...
public class JadenCaseTest extends TestCase {
    ...
    @Test
    public void test() {
        assertEquals("toJadenCase doesn't return a valide eight_kyu.JadenCase String! try again please :)", "Most Trees Are Blue", jadenCase.toJadenCase("most trees are blue"));
    }
